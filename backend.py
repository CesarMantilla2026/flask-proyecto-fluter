...
# Configuración del intérprete de TFLite
...
def clasificar_api():
    ...
    # Construcción de las probabilidades estructuradas
    probabilities = {
        class_names[i]: float(f"{prob:.4f}") for i, prob in enumerate(prediction)
    }
    
    # Generación y guardado del gráfico de barras estático
